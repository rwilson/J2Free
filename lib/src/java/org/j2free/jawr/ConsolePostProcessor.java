...
public class ConsolePostProcessor implements ResourceBundlePostProcessor {
    ...
    public static void main(String[] args) {
        ConsolePostProcessor cpp = new ConsolePostProcessor();
        String test = "function(something) { window.console.log('in something'); alert('hi'); }";
        System.out.println(cpp.removeLogStatements(test));
    }
}
