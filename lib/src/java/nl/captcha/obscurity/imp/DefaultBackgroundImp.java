...
public class DefaultBackgroundImp implements BackgroundProducer {
    ...
    public  BufferedImage addBackground(BufferedImage image){
        ...
        Color from = Helper.getColor(props.getProperty(BackgroundProducer.SIMPLE_CAPCHA_BCKGRND_CLR_FRM),Color.lightGray);
        Color to   = Helper.getColor(props.getProperty(BackgroundProducer.SIMPLE_CAPCHA_BCKGRND_CLR_T), Color.white);
